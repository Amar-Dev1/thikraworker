	...
	async fetch(request, env) {
		...
		if (request.method === 'POST' || url.pathname === '/update') {
			try {
				...
				const latestVersion = env.LATEST_VERSION || '2.1.2';
				const bundleUrl = env.BUNDLE_URL || 'https://github.com/Amar-Dev1/thikra-capacitor/releases/download/v2.1.2/bundle-ota.zip';
